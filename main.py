...
def prepare_input(credit_score, location, gender, age, tenure, 
...
def explain_prediction(probability, input_dict, surname):
    ...
    specialize in interpreting and explaining predictions of machine learning
    models.
  ...
  - If the customer has less than a 40% risk of churning, generate a 3 
  sentence explanation of why they might not be at risk of churning.
  - Your explanation should be based on the customer's information, the
  summary statistics of churned and non-churned customers, and the feature
  importances provided.

    Don't mention the probability of churning, or the machine learning model,
  or say anything like "Based on the machine learning model's prediction and
  top 10 most important features", just explain the prediction.
...
def generate_email(probability, input_dict, explanation, surname):
    prompt = f"""You are a manager at HS Bank. You are responsible for ensuring customers stay with the bank and are incentivised with various offers.
    ...
    Make sure to list out a set of incentives to stay based on their infomration, in bullet point format. Don't ever mention the probability of churning, or the machine learning model to the customer.
    """
